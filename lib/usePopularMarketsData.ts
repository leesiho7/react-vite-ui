...
const DEFAULT_POPULAR_MARKETS: PopularMarketItem[] = [
  ...
  { name: 'S&P 500', ticker: 'SPX', logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="%23d9251d"/><text x="50" y="58" font-size="28" font-weight="900" font-family="Arial,sans-serif" fill="%23ffffff" text-anchor="middle">S%26P</text></svg>', price: '$5,842.91', change: '+0.37%', tagKo: '미국 대형주 500 지수', tagEn: 'US S&P 500 Benchmark', isUp: true },
  { name: 'NASDAQ 100', ticker: 'NDX', logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="%23004b87"/><text x="50" y="58" font-size="22" font-weight="900" font-family="Arial,sans-serif" fill="%23ffffff" text-anchor="middle">NDX</text></svg>', price: '$20,118.44', change: '+0.61%', tagKo: '나스닥 빅테크 100 지수', tagEn: 'NASDAQ 100 Tech', isUp: true },
  { name: 'HSI Hang Seng', ticker: 'HSI', logo: 'https://financialmodelingprep.com/image-stock/HSI.png', price: '20,428.80', change: '+1.24%', tagKo: '홍콩 항생 대표 지수', tagEn: 'Hong Kong Hang Seng Index', isUp: true },
  { name: 'GOLD', ticker: 'XAU', logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="%23eab308"/><path d="M30 62 L50 35 L70 62 Z" fill="%23ffffff"/><text x="50" y="76" font-size="18" font-weight="900" font-family="Arial,sans-serif" fill="%23713f12" text-anchor="middle">GOLD</text></svg>', price: '$2,348.70', change: '-0.12%', tagKo: '실물 금 안전자산', tagEn: 'Physical Gold Commodity', isUp: false },
  { name: 'GOOGL', ticker: 'GOOGL', logo: 'https://financialmodelingprep.com/image-stock/GOOGL.png', price: '$178.20', change: '+1.88%', tagKo: '알파벳·제미나이 AI', tagEn: 'Alphabet & Gemini AI', isUp: true },
