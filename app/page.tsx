...
function getSymbolLogo(nameOrTicker: string): string {
  ...
  if (sym.includes('S&P') || sym.includes('SPX') || sym.includes('500') || sym.includes('SPY')) return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="%23d9251d"/><text x="50" y="58" font-size="28" font-weight="900" font-family="Arial,sans-serif" fill="%23ffffff" text-anchor="middle">S%26P</text></svg>'
  if (sym.includes('NASDAQ') || sym.includes('NDX') || sym.includes('QQQ')) return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="%23004b87"/><text x="50" y="58" font-size="22" font-weight="900" font-family="Arial,sans-serif" fill="%23ffffff" text-anchor="middle">NDX</text></svg>'
  if (sym.includes('HSI') || sym.includes('HANG SENG') || sym.includes('항생')) return 'https://financialmodelingprep.com/image-stock/HSI.png'
  if (sym.includes('GOLD') || sym.includes('XAU') || sym === 'GLD') return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="%23eab308"/><path d="M30 62 L50 35 L70 62 Z" fill="%23ffffff"/><text x="50" y="76" font-size="18" font-weight="900" font-family="Arial,sans-serif" fill="%23713f12" text-anchor="middle">GOLD</text></svg>'
