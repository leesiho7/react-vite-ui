...
const initialStories: Story[] = [
  {
    ...
    title: ['Rates, liquidity and the next risk regime', '금리·유동성과 경제 기계의 작동 원리', '利率、流动性与经济运行机制'],
  ...
  },
  {
    ...
    link: 'https://www.youtube.com/watch?v=Y7dpJ0oseIA',
    takeaways: [
