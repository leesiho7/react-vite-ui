...
import { ChevronRight, ExternalLink, RefreshCw, Send, AlertTriangle, ShieldCheck, UserRound, ArrowUpRight, BarChart2, CheckCircle2, ChevronDown, ChevronUp, Cpu, Crown, Filter, MessageSquare, Play, Sparkles, X, Award, Search, Copy, Check, Radio, Bot, Image as ImageIcon, FileText, Camera, BookOpen, Plus, Layers, MoreHorizontal, SquareTerminal, Square, Trash2, CreditCard, Server } from 'lucide-react';
import ReactMarkdown from 'react-markdown';
import remarkGfm from 'remark-gfm';
import { PrismLight as SyntaxHighlighter } from 'react-syntax-highlighter';
import { oneLight } from 'react-syntax-highlighter/dist/esm/styles/prism';

export function ResearchPanel(props: any) {
  const { language, researchMode, setResearchMode, agentSessions, setAgentSessions, currentSession, setCurrentSession, researchPrompt, setResearchPrompt, isResearchLoading, handleResearchSubmit, formatTime, resetResearchMemory, setIsCopilotExpanded } = props;
